...
<body>
    ...
    <form class="form-group text-center" action="<?php echo e(route('connection')); ?>" method="post">
    ...
    <form action="<?php echo e(route('inscription')); ?>" method="get">
        <div class="control text-center">
            <button class="btn btn-danger text-center" type="submit">S'inscrire</button>
        </div>
    </form>
    </div>
...
<?php /**PATH C:\Users\User\Desktop\ProjetPHP\TeamGiften couleur\TeamGift6\resources\views/connexion/login.blade.php ENDPATH**/ ?>