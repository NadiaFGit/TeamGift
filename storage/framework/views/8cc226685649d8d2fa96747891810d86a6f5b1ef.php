...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(url('/deconnexion')); ?>" method="Get">
        ...
        <button class="btn btn-outline-danger" style="float: right" type="submit"> Déconnection</button>
    </form>
    <form action="<?php echo e(url('/deconnexion')); ?>" method="Get">
        <?php echo e(csrf_field()); ?>

        <button class="btn btn-outline-danger" style="float:right;margin-right:20px;" type="submit"> Retour</button>
    </form>
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\TeamGiften couleur\TeamGift6\resources\views/detailEvenement.blade.php ENDPATH**/ ?>