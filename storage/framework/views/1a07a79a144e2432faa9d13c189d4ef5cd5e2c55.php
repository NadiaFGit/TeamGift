...
<body>
    ...
    <form action="<?php echo e(route('inscription')); ?>" method="post" class="section"
        ...
        <div class="control">
            <button class="btn btn-danger" type="submit">S'enregistrer</button>
        </div><br>
    ...
    <form action="<?php echo e(url('/deconnexion')); ?>" method="Get">
        ...
        <button class=" control btn btn-danger text-center"  type="submit">Se connecter</button>
    </form>
...
<?php /**PATH C:\Users\User\Desktop\TeamGiften couleur\TeamGift6\resources\views/connexion/signin.blade.php ENDPATH**/ ?>