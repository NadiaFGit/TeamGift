...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(url('/deconnexion')); ?>" method="Get">
        ...
        <button class="btn btn-danger" style="float:right;margin-right:20px;" type="submit"> Retour</button>
    </form>
    <br><br><br>
    ...
    <div class="">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a class="btn btn-danger" href="<?php echo e(route('newevement', $userG->ID)); ?> ">Créer
                            un événement</a></h5>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a class="btn btn-danger"
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\ProjetPHP\TeamGiften couleur\TeamGift6\resources\views/connexion/profile.blade.php ENDPATH**/ ?>