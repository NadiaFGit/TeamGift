...
<form action="<?php echo e(url('/deconnexion')); ?>" method="Get">
  ...
  <form action="<?php echo e(route('listeMescontributions', Session::get('user1'))); ?> " method="Get">
    ...
    <button class="btn btn-outline-danger" style="float: right" type ="submit">Mes contributions</button>
  </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <form class="text-center" action="<?php echo e(route('detailEvenement')); ?>" method="POST">
                                ...
                                <button class="btn btn-danger" type="submit" value="accepter ">Accepter</button>
                            </form><br>
                        </td>
                    </tr>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\ProjetPHP\TeamGiften couleur\TeamGift6\resources\views/listeEventsRecus.blade.php ENDPATH**/ ?>