...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('CreerEventPart')); ?>" method="post">
        ...
        <br>
        <button class="btn btn-danger" type="submit">Créer Événement</button>
    </form>


<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\TeamGiften couleur\TeamGift6\resources\views/createEvent.blade.php ENDPATH**/ ?>